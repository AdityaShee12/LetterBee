...
//                   {msg.message && (
//                     <div
//                       className={`font-mono bg-[#4337e6] text-white px-3 py-2 rounded-lg min-w-[80px] max-w-full break-words whitespace-pre-line mt-2 block ${msg.sender === "You" ? "bg-[#4337e6]" : "bg-yellow-700"
//                         }`}
//                       style={{
